...
```mermaid
graph TD
    subgraph EXTERNAL["🌍 External Forces"]
        E1[시장 변화]
        E2[기술 발전]
        E3[규제 환경]
    end
    subgraph INTERNAL["🏢 Internal Forces"]
        I1[조직 역량]
        I2[기존 시스템]
        I3[리소스]
    end
    subgraph STRATEGY["🎯 Strategic Response"]
        S[전략 방향]
    end
    EXTERNAL --> S
    INTERNAL --> S
...
gantt
    ...
    [태스크 1]           :2026-04, 2026-06
    [태스크 2]           :2026-05, 2026-07
    section Phase 2 확장
    [태스크 3]           :2026-07, 2026-10
    [태스크 4]           :2026-08, 2026-11
    section Phase 3 최적화
    [태스크 5]           :2026-11, 2027-02
```
...
xychart-beta
    ...
    y-axis "Amount ($K)" -500 --> 1000
    bar [-200, -150, -100, 100, 300, 500]
```
